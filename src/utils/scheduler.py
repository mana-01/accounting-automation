...
class Scheduler:
    ...
    def _send_monthly_reminder(self):
        ...
        try:
            ...
            manual_items = spreadsheet_service.get_subscriptions(active_only=True, category="manual")
            scan_items = spreadsheet_service.get_subscriptions(active_only=True, category="scan")
